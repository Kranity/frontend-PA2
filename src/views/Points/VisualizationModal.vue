        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    <p class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Nome: {{item.name}}</p>
                    <p class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Latitude: {{item.latitude}}</p>
                    <p class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Longitude: {{item.longitude}}</p>
